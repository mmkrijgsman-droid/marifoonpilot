...
try { importScripts("config.js?v=5.0.0"); } catch (e) { console.warn("sw: config.js niet geladen", e); }
const HOSTS = (typeof TILE_HOSTS !== "undefined" && Array.isArray(TILE_HOSTS)) ? TILE_HOSTS : HOST_FALLBACK;

const VERSION = "mp2-v5.0.0";
...
const SHELL_FILES = [
  ...
  "./", "./index.html", "./config.js?v=5.0.0", "./app.js?v=5.0.0", "./data.js?v=5.0.0",
  "./vhf-points.js?v=5.0.0", "./fairway-depths.js?v=5.0.0", "./obstacles.js?v=5.0.0", "./stations.js?v=5.0.0", "./manifest.webmanifest",
