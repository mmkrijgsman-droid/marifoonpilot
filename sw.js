...
try { importScripts("config.js?v=5.2.1"); } catch (e) { console.warn("sw: config.js niet geladen", e); }
const HOSTS = (typeof TILE_HOSTS !== "undefined" && Array.isArray(TILE_HOSTS)) ? TILE_HOSTS : HOST_FALLBACK;

const VERSION = "mp2-v5.2.1";
...
const SHELL_FILES = [
  ...
  "./", "./index.html", "./config.js?v=5.2.1", "./app.js?v=5.2.1", "./data.js?v=5.2.1",
  "./vhf-points.js?v=5.2.1", "./fairway-depths.js?v=5.2.1", "./obstacles.js?v=5.2.1", "./stations.js?v=5.2.1", "./manifest.webmanifest",
