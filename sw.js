...
try { importScripts("config.js?v=5.3.0"); } catch (e) { console.warn("sw: config.js niet geladen", e); }
const HOSTS = (typeof TILE_HOSTS !== "undefined" && Array.isArray(TILE_HOSTS)) ? TILE_HOSTS : HOST_FALLBACK;

const VERSION = "naviq-v5.3.0";
...
const SHELL_FILES = [
  ...
  "./", "./index.html", "./config.js?v=5.3.0", "./app.js?v=5.3.0", "./data.js?v=5.3.0",
  "./vhf-points.js?v=5.3.0", "./fairway-depths.js?v=5.3.0", "./obstacles.js?v=5.3.0", "./stations.js?v=5.3.0", "./manifest.webmanifest",
