 ...
 *
 * Alleen bij bruggen:
 *   clearance = doorvaarthoogte in GESLOTEN toestand (m). Ontbreekt of null = onbekend;
 *               de app neemt dan aan dat de brug open moet (veilige kant).
 *   opens     = true bij een beweegbare brug, false bij een vaste brug (gaat nooit open).
 *
 * ⚠️ Doorvaarthoogtes zijn t.o.v. het streefpeil/NAP en variëren met het waterpeil.
 *    Ze staan hier als planningshulp — controleer altijd de Wateralmanak deel 2.
 */
const POINTS = [
  // Afsluitdijk
  ...
  { id:"ketelbrug", name:"Ketelbrug", sub:"A6 · Ketelmeer", type:"brug", channel:18, lat:52.6125, lon:5.6455, radius:700, conf:"high", clearance:10.4, opens:true,
    reason:"Beweegbare brug A6. Opening 10 min vóór heel en half uur; buiten seizoen op afroep. Kanaal 18. Beweegbaar deel 10,4 m gesloten (vast deel 12,58 m)." },
  ...
  { id:"ramspol", name:"Ramspolbrug", sub:"N50 · Ramsdiep", type:"brug", channel:20, lat:52.6135, lon:5.8413, radius:700, conf:"medium", clearance:13.67, opens:true,
    reason:"Beweegbare brug over het Ramsdiep. Buiten seizoen op afroep. Kanaal 20 (op één bron — controleren). Basculedeel 13,67 m gesloten (vast deel Ramsgeul 13,8 m)." },
  { id:"elburgerbrug", name:"Elburgerbrug", sub:"N309 · Drontermeer ↔ Veluwemeer", type:"brug", channel:64, lat:52.4575, lon:5.8166, radius:500, conf:"medium", clearance:5.4, opens:true,
    reason:"Basculebrug N309 tussen Drontermeer en Veluwemeer. Bediening kanaal 64, draait op afroep op vaste tijden (09:30–15:30). Beweegbaar deel 5,7 m gesloten; naast de brug liggen vaste doorvaarten tot 5,40 m (NAP) die altijd open staan — vandaar 5,4 m als grens. Kanaal op één bron — controleren." },
  ...
  { id:"moorman", name:"Moormanbrug", sub:"Den Helder", type:"brug", channel:18, lat:52.9548, lon:4.7799, radius:500, conf:"high", clearance:null, opens:true,
    reason:"Vice-Admiraal Moormanbrug. Kanaal 18. Doorvaarthoogte niet geverifieerd — de app rekent hier altijd met openen." },
  // Waddenzee oost
